...
public class ORDSTest {
    ...
    public void verifyCountriesTest1() {
        ...
        given().accept(ContentType.JSON).
                ...
                then().assertThat().statusCode(200).contentType(ContentType.JSON).body("items[0].country_name", is ("United States of America"));
        ...
        Map<String, Object> countyUS = response.jsonPath().get("items.find {it.country_id == 'US'}");
        ...
        System.out.println(countyUS);
        System.out.println(countryNames);

        for(Map.Entry<String, Object> entry : countyUS.entrySet()){
